...
import { FriendsPage } from '@/components/launcher/friends-page'
import { FriendsPanel } from '@/components/launcher/friends-panel'
import { MessagesPage } from '@/components/launcher/messages-page'
...
export default function App() {
  ...
  useEffect(() => {
    if (user) {
      friendService.startPresence().catch(() => {})
    }
  }, [user])

  useEffect(() => {
    const onUnload = () => {
      friendService.stopPresence()
    }
          ...
          <div className="flex min-h-0 flex-1">
            ...
            <div className="flex w-80 shrink-0 flex-col border-l border-border bg-background/60">
              <div className="flex min-h-0 flex-1 flex-col gap-3 px-4 pb-4">
                ...
                <NewsPanel />
                <FriendsPanel onNavigate={setActivePage} />
                <QuickActions />
              </div>
            </div>
          </div>
