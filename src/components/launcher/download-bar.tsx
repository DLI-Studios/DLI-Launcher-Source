      ...
      {done ? (
        <div className="flex items-center gap-4 rounded-xl border border-white/10 bg-white/5 px-5 py-3 backdrop-blur-md">
          ...
          <div className="flex min-w-0 flex-1 flex-col">
            <span className="truncate text-sm font-semibold text-white">Minecraft {version} ready!</span>
            <span className="text-xs text-white/50">Starting game...</span>
          </div>
        </div>
      ) : isError ? (
        <div className="flex items-center gap-4 rounded-xl border border-white/10 bg-white/5 px-5 py-3 backdrop-blur-md">
        ...
        <div className="flex items-center gap-4 rounded-xl border border-white/10 bg-white/5 px-5 py-3 backdrop-blur-md">
          <span className="flex size-10 shrink-0 items-center justify-center rounded-lg bg-purple-500/15">
          ...
          <div className="flex min-w-0 flex-1 flex-col gap-1.5">
            <div className="flex items-center justify-between gap-4 text-sm">
              ...
              <span className="flex shrink-0 items-center gap-4 text-xs text-white/60">
                <span>{Math.floor(progress)}% downloaded &bull; {100 - Math.floor(progress)}% remaining</span>
              </span>
            </div>
            {currentFile && (
